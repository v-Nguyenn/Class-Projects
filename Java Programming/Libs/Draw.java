...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static void main(String[] args) {
        ...
        Draw draw1 = new Draw();
        draw1.setTitle("CS38 Test 1");
        draw1.rectangle(0.2, 0.8, 0.1, 0.05);
        draw1.pause(wait);
        double x=Math.random()/2,y=Math.random()/2,halfW,halfH;
        draw1.pause(wait);
        x=Math.random()*0.8; y=Math.random()*0.8;
        halfW=Math.random()*0.5;
        draw1.setPenColor(Draw.RED);
        draw1.filledCircle(x, y, halfW);
        draw1.pause(wait);

        x=Math.random()*0.8; y=Math.random()*0.8;
        draw1.setPenColor(Draw.GREEN);
        draw1.filledRectangle(x, y, 0.15, 0.2);
        draw1.pause(wait);
        ...
        // create another one
        Draw draw2 = new Draw();
        draw2.setCanvasSize(500, 500);
        draw2.setTitle("CS38 Test 2");
        // draw a blue diamond
        draw2.setPenRadius();
        draw2.setPenColor(Draw.BLUE);
        double[] xPos = { 0.1, 0.2, 0.3, 0.2 };
        double[] yPos = { 0.2, 0.3, 0.2, 0.1 };
        draw2.filledPolygon(xPos, yPos);
        ...
        draw2.setFont( fnt );
        draw2.setPenColor(Draw.BLUE);
        draw2.text(0.3, 0.9, "large text");
        draw2.pause(wait);

        draw2.setPenColor(Draw.RED);
        draw2.text(0.3, 0.3, "slanted text", 60);
    }
